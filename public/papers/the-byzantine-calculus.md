---
title: "The Byzantine Calculus: Quantifying Distributed Ledger Security as Enterprise Financial Risk"
...
type: "doctrine"
keywords: ["Byzantine Fault Tolerance", "Cost-of-Corruption", "Contagion Models", "Post-Quantum Crypto"]
version: "1.0"
status: "Final"
---
...
- [Fiduciary Duties and Criminal Liability](#fiduciary-duties-and-criminal-liability-establish-governance-imperatives)
- [Regulatory Frameworks](#regulatory-frameworks-eliminate-architectural-safe-harbors)
- [Post-Quantum Cryptography](#post-quantum-cryptography-transition-quantifies-cryptographic-obsolescence-risk)
- [Cross-Chain Contagion](#cross-chain-contagion-models-quantify-systemic-risk-amplification)
- [Maximal Extractable Value](#maximal-extractable-value-creates-consensus-layer-security-externalities)
- [Nation-State Adversaries](#nation-state-adversaries-operate-beyond-financial-incentive-structures)
- [Cryptoeconomic Security](#cryptoeconomic-security-models-establish-quantifiable-cost-of-corruption-bounds)
...
### *Elimination of Architectural Safe Harbors*

#### **Basel Committee Prudential Treatment (SCO60, Effective January 2025)**

**Binary Classification System:**

**Group 1 Cryptoassets** (Conventional Treatment)
- Tokenized traditional assets
- Qualifying stablecoins
- **Requirements**: All five conditions must be met
  - Effective stabilization mechanism
  - Legally enforceable rights with 5-day settlement finality
  - Risk-mitigating network design with traceable transactions
  - Regulated entities executing redemptions/transfers

**Group 2 Cryptoassets** (Punitive Treatment)
- **2a Assets**: 100% risk weighting with limited hedging recognition
  - Minimum $10B market cap
  - $50M daily volume
  - 100+ price observations
- **2b Assets**: **1250% risk weighting**
  - Capital equal to full exposure value
  - No hedging recognition permitted
  - Hard exposure limits: 1% of Tier 1 capital (2% absolute ceiling)

#### **IOSCO DeFi Policy Recommendations (December 2023)**

**Nine Core Principles Eliminating "Decentralization Defense":**

**1. Responsible Person Identification**
- Founders, developers, token issuers
- DAO participants with governance rights
- Smart contract administrative rights holders
- Protocol deployers retaining ongoing control

**2. Enforcement Priority**
- Substance over form regardless of labels
- All persons offering financial products must comply with applicable laws
- DAO organization does not abdicate regulatory responsibilities

**Six Key Risk Areas Addressed:**
- Vertical integration conflicts
- Market manipulation and fraud
- Cross-border regulatory arbitrage
- Custody and asset safeguarding
- Operational resilience (smart contracts, oracle manipulation)
- Governance attack vectors

#### **EU AI Act Implications for DLT**

**Article 53 & 55 Requirements for ML-Integrated DLT:**
- Technical documentation covering training and testing processes
- Downstream provider information for capability understanding
- Copyright compliance policies with state-of-the-art technologies
- Public training data summaries
- **Systemic Risk Models** (>10²⁵ FLOPs): Additional evaluation protocols, adversarial testing, incident reporting

---

## Post-Quantum Cryptography
### *Cryptographic Obsolescence Risk Quantification*

#### **NIST Final Standards (August 13, 2024)**

**FIPS 203: ML-KEM (Module-Lattice-Based Key-Encapsulation)**
- Derived from CRYSTALS-KYBER
- **Security Levels**:
  - ML-KEM-512: 128-bit security, 800-byte public keys
  - ML-KEM-768: 192-bit security, larger keys
  - ML-KEM-1024: 256-bit security, 1,568-byte keys
- Decapsulation failure rate: 2⁻¹³⁸·⁸
...
- **Security Levels**:
  ...
  - ML-DSA-65: 192-bit security, 3,309-byte signatures
  - ML-DSA-87: 256-bit security, 4,627-byte signatures

#### **Quantum Computing Timeline**

**Google Willow Processor (December 2024)**
- 105 physical qubits with below-threshold error correction
- Single-qubit gate error: 0.035% ± 0.029%
- Two-qubit gate error: 0.33% ± 0.18%
- Completed in 5 minutes what classical computers need 10²⁵ years

**Breaking RSA-2048 Requirements**
- 1,730 logical qubits
- 2³⁶ quantum gate operations
- 4,000-20,000,000 physical qubits (depending on error correction)

**Probability Assessments**
- **19-34%** probability of cryptographically relevant quantum computers by 2034
- 5-14% probability by 2029
- IonQ roadmap: 1,600 logical qubits by 2028, 40,000-80,000 by 2030

#### **"Harvest Now, Decrypt Later" Threat**

**Immediate Risk Factors**
- Data with 10+ year sensitivity lifespan faces immediate risk
- Australian Signals Directorate: Transition complete by 2030
- U.S. NSA CNSA 2.0: Migration required by 2035

**DLT-Specific Vulnerabilities**
- ECDSA completely vulnerable to Shor's algorithm
- SHA-256 reduced to 128-bit effective security via Grover's algorithm
- AES-128 reduced to 64-bit (borderline vulnerable)
- AES-256 maintains acceptable 128-bit post-quantum security
